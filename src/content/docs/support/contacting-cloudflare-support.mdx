...
| [Support case](#getting-help-with-an-issue)<br/>Use to troubleshoot specific issues or errors. Response times depend on your plan.                                                                                   | Yes        | Yes      | Yes         | No[^1]        |
...
[^1]: Customers on Free plans are encouraged to utilize our Cloudflare Community and will only receive standard case support for billing, account, and registrar issues.
...
3. Click **Configure authenticator app** and follow the [configuration instructions](/fundamentals/user-profiles/2fa/#configure-totp-mobile-application-authentication).
...
Cloudflare Support only accepts the Cloudflare One Client diagnostics as compressed files.
Please do not upload ZIP or RAR files when sharing [HAR files](/support/troubleshooting/general-troubleshooting/gathering-information-for-troubleshooting-sites/#generate-a-har-file), and please do not share compressed documents like DOCX, XLSX, or PPTX.
